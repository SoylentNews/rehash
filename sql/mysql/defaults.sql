...
INSERT INTO vars (name, value, description) VALUES ('cvs_tag_currentcode','T_2_5_0_126','The current cvs tag that the code was updated to - this does not affect site behavior but may be useful for your records');
