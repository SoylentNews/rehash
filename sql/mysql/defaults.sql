...
INSERT INTO vars (name, value, description) VALUES ('comments_portscan_all_for_proxy', '0', 'If true, when ANY posting is attempted, try to access our own site ok.txt using incoming IP as a proxy, and forbid posting if successful -- overrides comments_portscan_anon_for_proxy');
