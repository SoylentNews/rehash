...
5.6.1 is recommended. We have found no problems with 5.8.0, so
if you have that, don't downgrade on our account.]
...
Our development of 2.3/2.4 has gone on exceptionally long without an
