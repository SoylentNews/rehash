...
Just run the script formkeys.sql in the F<sql/updates/1.0.3/>
...
=head2 Upgrade 1.0.3 -> 1.0.4
Just run the script formkeys.sql in the F<sql/updates/1.0.4/>
directory, and make sure you have the latest code.  

=head2 Upgrade 1.0.4 -> 1.0.5
Just run the udpate script in the F<sql/updates/1.0.5/>
directory, and make sure you have the latest code.  
