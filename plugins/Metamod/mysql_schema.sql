...
ALTER TABLE moderatorlog ADD COLUMN m2count mediumint UNSIGNED NOT NULL DEFAULT '0', m2needed mediumint UNSIGNED NOT NULL DEFAULT '0', m2status tinyint DEFAULT '0' NOT NULL, ADD INDEX m2stat_act (m2status,active);
