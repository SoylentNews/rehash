...
INSERT INTO blocks (bid, block, seclev, type, description, skin, ordernum, title, portal, url, rdf, retrieve, hidden) VALUES ('articles_more','',1000,'static',NULL,'articles',5,'Articles',0,NULL,NULL,0,1);
...
INSERT INTO blocks (bid, block, seclev, type, description, skin, ordernum, title, portal, url, rdf, retrieve, hidden) VALUES ('features_more','',1000,'static',NULL,'features',5,'more',0,NULL,NULL,0,1);
INSERT INTO blocks (bid, block, seclev, type, description, skin, ordernum, title, portal, url, rdf, retrieve, hidden) VALUES ('features_qlinks','<!-- begin quicklinks block -->\n<A HREF=\"http://newsforge.com/\">NewsForge</A><BR>\n<A HREF=\"http://lists.slashdot.org/mailman/listinfo.cgi\">Slash Mailing lists</A><BR>\n<A HREF=\"http://www.slashcode.com/\">Slashcode.com</A><BR>\n<A HREF=\"http://slashdot.org/\">Slashdot</A><BR>\n<A HREF=\"http://ostg.com/\">OSTG</A><BR>\n<A HREF=\"http://CmdrTaco.net/\">CmdrTaco.net</A><BR>\n<A HREF=\"http://www.cowboyneal.org/\">Cowboyneal.org</A><BR>\n<A HREF=\"http://pudge.net/\">Pudge.Net</A><BR>\n<A HREF=\"http://tangent.org/\">TangentOrg</A><BR>\n<A HREF=\"http://thinkgeek.com/\">ThinkGeek</A><BR>\n\n<!-- end quicklinks block -->',500,'static',NULL,'features',7,'Quick Links',0,NULL,NULL,0,1);
INSERT INTO blocks (bid, block, seclev, type, description, skin, ordernum, title, portal, url, rdf, retrieve, default_block) VALUES ('index_more','',1000,'static',NULL,'mainpage',5,'Older Stuff',1,NULL,NULL,0,1);
INSERT INTO blocks (bid, block, seclev, type, description, skin, ordernum, title, portal, url, rdf, retrieve, default_block) VALUES ('index_qlinks','<!-- begin quicklinks block -->\r\n\r\nYou should put some links here to other sites that your users might enjoy.\r\n\r\n<!-- end quicklinks block -->\r\n\r\n',500,'static',NULL,'mainpage',7,'Quick Links',1,NULL,NULL,0,1);
...
INSERT INTO blocks (bid, block, seclev, type, description, skin, ordernum, title, portal, url, rdf, retrieve, hidden) VALUES ('spamurlregexes','',100,'static','Whitespace-delimited list of regexes which indicate a spammer URL.','mainpage',5,'Spam URL Regexes',0,NULL,NULL,0,1);
...
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('\bviagra\b','comments', 'gi','postersubj',0.0000,0,0,'No Spam Please!');
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('\bviagra\b','comments', 'gi','postercomment',0.0000,0,0,'No Spam Please!');
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('\bcialis\b','comments', 'gi','postersubj',0.0000,0,0,'No Spam Please!');
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('\bcialis\b','comments', 'gi','postercomment',0.0000,0,0,'No Spam Please!');
...
INSERT INTO content_filters (form, regex, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('submissions','\bviagra\b','gi','subj',0.0000,0,0,'No Spam Please!');
INSERT INTO content_filters (form, regex, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('submissions','\bviagra\b','gi','story',0.0000,0,0,'No Spam Please!');
INSERT INTO content_filters (form, regex, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('submissions','\bviagra\b','gi','email',0.0000,0,0,'No Spam Please!');
INSERT INTO content_filters (form, regex, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('submissions','\bcialis\b','gi','subj',0.0000,0,0,'No Spam Please!');
INSERT INTO content_filters (form, regex, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('submissions','\bcialis\b','gi','story',0.0000,0,0,'No Spam Please!');
INSERT INTO content_filters (form, regex, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('submissions','\bcialis\b','gi','email',0.0000,0,0,'No Spam Please!');
